...
//               $clone.find('.goods-d-info').find('a').attr('href','http://10.31.162.171/UNIT2/lab/src/details.html?'+data[i].sid);
...
//               $clone.find('.b-sum strong').html('在线询价');//num：数量
...
//   var total = 0;//总的价格
//   var countnum = 0;//总的数量
//   $('.goods-item:visible').each(function() {//可视的chec商品列表进行遍历，循环叠加
//       if ($(this).find('input:checkbox').is(':ked')) {//商品的复选框是选中的
